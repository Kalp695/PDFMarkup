...
//
+ (id)loadingViewInView:(UIView *)aSuperview inLoadingText:(NSString*)loadingText
{
	...
	//loadingLabel.font = [UIFont boldSystemFontOfSize:[UIFont labelFontSize]];
      [loadingLabel setNuiClass:@"Label:SmallLabelLoadingFont"];
    ...
    //activityIndicatorView.frame=CGRectMake(loadingView.frame.size.width/2.0f, loadingView.frame.size.height/2.0f, 100.0f, 100.0f);
...
- (void)drawRect:(CGRect)rect
{
	...
	CGPathRef roundRectPath = NewPathWithRoundRect(CGRectMake(self.frame.size.width/2.0f-50.0f, self.frame.size.height/2.0f-50.0f, 100.0f, 100.0f), ROUND_RECT_CORNER_RADIUS);
